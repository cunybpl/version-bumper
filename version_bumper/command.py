...
class VersionBumperCommand(VersionCommand):
    ...
    options: list[Option] = [
        ...
        option(
            "push",
            "-p",
            "Whether to push that tag or not. (?)",
            flag=True,
            value_required=False,
        ),
        option(
            "dry-run",
            "-d",
            "Whether to actually make changes or not",
            flag=True,
            value_required=False,
        ),
    ]
